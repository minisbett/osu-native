...
public static class OsuNative
{
    ...
    public static extern ErrorCode Performance_ComputeOsu(int beatmapContextId, OsuDifficultyAttributes diffAttributes, OsuScore score,
    ...
    public static extern ErrorCode Performance_ComputeTaiko(int beatmapContextId, TaikoDifficultyAttributes diffAttributes, TaikoScore score,
    ...
    public static extern ErrorCode Performance_ComputeCatch(int beatmapContextId, CatchDifficultyAttributes diffAttributes, CatchScore score,
    ...
    public static extern ErrorCode Performance_ComputeMania(int beatmapContextId, ManiaDifficultyAttributes diffAttributes, ManiaScore score,
